...
class GridDropout(BaseDropout):
    """Apply GridDropout augmentation to images, masks, bounding boxes, and keypoints.  See Args for parameters and types, Returns for output, and Examples for usage.
