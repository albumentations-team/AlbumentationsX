...
This document defines the release process for AlbumentationsX. Releases are cut from `main`, validated in CI, built in GitHub Actions, published to PyPI via trusted publishing, and attached to the corresponding GitHub Release together with checksums and SBOM artifacts.
